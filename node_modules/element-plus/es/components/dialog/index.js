...
const useDialog = (props, { emit }, targetRef) => {
  ...
  const style = computed(() => {
    ...
    if (!props.fullscreen) {
      ...
      if (props.width)
        style2.width = normalizeWidth.value;
    }
    return style2;
  });
  function afterEnter() {
...
const _hoisted_1 = { class: "el-overlay-dialog" };
const _hoisted_2 = ["aria-label"];
const _hoisted_3 = { class: "el-dialog__header" };
const _hoisted_4 = { class: "el-dialog__title" };
const _hoisted_5 = /* @__PURE__ */ createElementVNode("i", { class: "el-dialog__close el-icon el-icon-close" }, null, -1);
const _hoisted_6 = [
  _hoisted_5
];
const _hoisted_7 = {
          ...
          default: withCtx(() => [
            createElementVNode("div", _hoisted_1, [
              withDirectives(createElementVNode("div", {
                ...
                _ctx.rendered ? (openBlock(), createElementBlock("div", _hoisted_7, [
